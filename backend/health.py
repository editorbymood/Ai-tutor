...
def metrics(request):
    ...
    try:
        ...
        return JsonResponse(
            {"error": "Failed to collect metrics", "timestamp": time.time()}, status=500
        )
...
def cache_stats(request):
    ...
    try:
        ...
        return JsonResponse(
            {"error": "Failed to collect cache stats", "timestamp": time.time()},
            status=500,
        )
...
def database_stats(request):
    ...
    try:
        ...
        return JsonResponse(
            {"error": "Failed to collect database stats", "timestamp": time.time()},
            status=500,
        )
